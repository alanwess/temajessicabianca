<?php get_header(); //Template Name: Para empresa ?>  
				...
				<div class="nav-header">
					...
					<nav id="fh5co-menu-wrap" role="navigation"> 
						<ul class="sf-menu" id="fh5co-primary-menu">
							...
							<li class="active"><a href="<?= home_url( '/empresa' ); ?>">Para empresa</a></li>
				...
				<div class="container">
					<div class="row">
						<div class="col-md-8 col-md-offset-2 text-center heading-section animate-box">
							<h3>Veja os serviços que separamos para fazer sua empresa decolar ainda mais.</h3>
						</div>
					</div>
				</div>
				<div class="container">
					<div class="category-grid row col-md-12">
